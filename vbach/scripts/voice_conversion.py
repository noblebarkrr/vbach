...
def voice_pipeline(
    ...
    template_1 = f"{output_filename}_dif"
    template_2 = f"{output_filename}_mid"
    output_1 = os.path.join(output_dir, f"{template_1}.{output_format}")
    output_2 = os.path.join(output_dir, f"{template_2}.{output_format}")
    ...
    return output_path, output_1, output_2
